...
class ModelRun(Base):
    ...
    model: Mapped["ModelRegistry"] = relationship(back_populates="model_runs")
...
class SentimentScore(Base):
    ...
    positive_probability: Mapped[Decimal | None] = mapped_column(Numeric(10, 6), nullable=True)
    negative_probability: Mapped[Decimal | None] = mapped_column(Numeric(10, 6), nullable=True)
    neutral_probability: Mapped[Decimal | None] = mapped_column(Numeric(10, 6), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=datetime.utcnow)
...
class Forecast(Base):
    ...
    lower_bound: Mapped[Decimal | None] = mapped_column(Numeric(20, 6), nullable=True)
    upper_bound: Mapped[Decimal | None] = mapped_column(Numeric(20, 6), nullable=True)
...
class EarningsEvent(Base):
    ...
    revenue_estimate: Mapped[Decimal | None] = mapped_column(Numeric(24, 6), nullable=True)
    currency: Mapped[str] = mapped_column(String(10), default="INR")
...
class IntelligenceSignal(Base):
    ...
    stock: Mapped["Stock"] = relationship(back_populates="intelligence_signals")
