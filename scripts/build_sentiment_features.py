            ...
            rows.append(
                {
                    ...
                    "negative_probability": (
                        ...
                        if row.negative_probability is not None
                        else None
                    ),
                    "neutral_probability": (
                        float(row.neutral_probability)
                        if row.neutral_probability is not None
                        else None
                    ),
                }
            )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build causal daily and rolling sentiment features"
    )
